...
class iso_pond(iso_storage):
    ...
    def __init__(self,
        ...
        Constructor of iso_storage
        """
        iso_storage.__init__(self, upper_boundary, lower_boundary, cell, conc_iso_liquid, theta, T)

    # Property: layers
    def get_gas_volume(self):
        """
        @return: Returns the volume of the storage filled with gas in m3.
        """
        return self.volume * (1.0 - self.theta)
